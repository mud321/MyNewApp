...
const PickUpScreen = () => {
  ...
  return (
    ...
    <SafeAreaView style={{marginTop:50}}>
      <Text style={{ fontSize: 16, fontWeight: "500", marginHorizontal: 10 }}>Enter Address & What you Want </Text>
      <TextInput style={{ padding: 40, borderColor: "gray", borderWidth: 0.8, paddingVertical: 80, borderRadius: 9, margin: 10 }} />
    ...
    {total === 0 ? (
          ...
          >
            ...
            <Pressable onPress={proceedToCart}>
              <Text style={{fontSize:16,fontWeight:"600",color:"white"}}>Proceed to Cart</Text>
            </Pressable>
          </Pressable>
          )}
    </>
